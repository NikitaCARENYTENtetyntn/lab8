...
class MainActivity : AppCompatActivity() {
    ...
    private fun getBookData() {
        newBookList.add(BookDataClass(R.drawable.img, "Няшка", "Кот 1"))
        newBookList.add(BookDataClass(R.drawable.img2, "Две няшки", "Кот 2"))
        newBookList.add(BookDataClass(R.drawable.img3, "Бабочка няшка", "Кот 3"))
